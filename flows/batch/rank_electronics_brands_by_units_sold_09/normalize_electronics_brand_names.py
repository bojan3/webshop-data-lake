...
def normalize_electronics_brand_names(data_period: str) -> None:
    ...
    df = spark.read.option("header", "true").parquet(processing_electronics_purchases_path)
...
if __name__ == "__main__":
    args = parse_args()
    normalize_electronics_brand_names(args.data_period)
